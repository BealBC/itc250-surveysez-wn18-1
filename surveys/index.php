...
$config->metaDescription = 'Seattle Central\'s ITC 250 Class Surveys are made with pure PHP! ' . $config->metaDescription;
...
{#records exist - process
    ...
    echo "<div align=center>There are currently no surveys?  There must be a mistake!!</div>";	
}
